...
%information and afterwards with the help of "Cal_Fus_res.m" 
...
%          % disp('Train Test Divided ...'); 
        ...
        %frequency selection
         for low = flow:fHop:fhigh% this freq loop for testing subject specific performance across multiple frequency band 
            ...
            [dataTrain_f.x, dataTest_f.x] = MC_CSP(dataTrain_f,dataTest_f,cspPair);
...
save feat_fus_log_var_win feat_bank FeatS flow fhigh fHop fSpan winsize winhop featureN nfold cspPair%classifier   feat_fus_log_var, feat_fus_log_var_win
disp('saved')

Cal_Fus_res_sub_specific 
