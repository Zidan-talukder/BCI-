%this is the code for subject specific channel selection experiment. here
%we are trying to observe how channels from different location of the brain 
%can affect the performance the overall accuracy of the model

%the main portion of the code is used to record different combination of cahnnels
%information and afterwards with the help of "Cal_Fus_res_sub_specific_val_chn" 
%overall accuracy is found
