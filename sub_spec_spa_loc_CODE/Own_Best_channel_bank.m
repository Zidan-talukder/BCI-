...
save feat_fus_log_var_win_val_chn feat_bank FeatS Feats map flow fhigh fSpan chn winsize winhop featureN nfold cspPair%classifier   feat_fus_log_var, feat_fus_log_var_win
disp('saved')
Cal_Fus_res_CBCSP
