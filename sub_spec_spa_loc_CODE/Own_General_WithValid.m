...
% type 28
 %chn = {[8 9 14:16 21:24 30:33 38:41 46:48 53:55];[1 2 4:8 11:15 19:22 27:31 36:39 43:47 50:54 56:59]};
...
%         
        ...
        if(fold==nfold) si=1; end
         ...
         dataValidf.y = dataTrainf.y(si:(nfold-1):end);
         dataValidf.x = dataTrainf.x(:,:,si:(nfold-1):end);
         dataValidf.sf = dataTrainf.sf; 
         dataTrainf.y(si:(nfold-1):end)=[]; 
         dataTrainf.x(:,:,si:(nfold-1):end)=[];         
        ...
        dataValid = eegButterFilter(dataValidf, low, high, order);
